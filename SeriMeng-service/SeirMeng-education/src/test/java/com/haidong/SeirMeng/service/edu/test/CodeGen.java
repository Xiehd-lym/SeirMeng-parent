package com.haidong.SeirMeng.service.edu.test;
...
public class CodeGen {
    ...
    public void genCode() {
        ...
        String prefix = "seirmeng_";//用来拼接连接数据库的url地址数据库名称的、根据实际修改
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/" + prefix + "haidong_" + moduleName + "?serverTimezone=GMT%2B8");
